...
export default function HeroSection() {
  ...
  return (
    <section style={{
      ...
      <div style={{ maxWidth:'1200px', margin:'0 auto', padding:'4rem 2rem', width:'100%', display:'grid', gridTemplateColumns:'36% 64%', gap:'2rem', alignItems:'center', position:'relative', zIndex:1 }}>
        {/* Left copy */}
        <div>
          <div style={{ display:'inline-flex', alignItems:'center', gap:'8px', background:'rgba(182,147,248,0.12)', border:'1px solid rgba(182,147,248,0.3)', borderRadius:'100px', padding:'6px 16px', marginBottom:'2rem' }}>
            <span style={{ fontSize:'0.75rem', fontWeight:600, color:'#B693F8', letterSpacing:'0.05em' }}>AI-NATIVE · IP COMMERCIALIZATION</span>
          </div>
          <h1 style={{ fontFamily:"'AlibabaPuHuiTi','PingFang SC',sans-serif", fontSize:'clamp(3rem,5.5vw,5.2rem)', fontWeight:800, lineHeight:1.05, marginBottom:'1.5rem', letterSpacing:'-0.02em' }}>
        ...
        <div style={{ position:'relative', height:'640px' }}>
          ...
          {/* ── ROW 1 ── left→right: Bear Taidi → NASA → TadaCoffee */}

          {/* Card 1 — Bear Taidi: row-1 leftmost, z:2 */}
          <div ref={el => { cardsRef.current[0] = el }} style={{
          ...
          <div ref={el => { cardsRef.current[1] = el }} style={{
          ...
          <div ref={el => { cardsRef.current[2] = el }} style={{
          ...
          {/* ── ROW 2 ── left→right: Bear Baby → Bear Fashion → Coming Soon */}

          {/* Card 4 — 泰迪婴童: row-2 leftmost, z:1 */}
          <div ref={el => { cardsRef.current[3] = el }} style={{
          ...
          <div ref={el => { cardsRef.current[4] = el }} style={{
          ...
          <div ref={el => { cardsRef.current[5] = el }} style={{
      ...
      <style>{`@media(max-width:900px){section>div>div:nth-child(2){grid-template-columns:1fr!important}section>div>div:last-child{display:none!important}}`}</style>
    </section>
  )
}
