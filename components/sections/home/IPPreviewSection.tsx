    ...
    <section style={{ padding: '6rem 2rem', background: '#FFF8F4' }}>
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: '3rem', flexWrap: 'wrap', gap: '1rem' }}>
          <div>
            <div style={{
              fontSize: '0.75rem', fontWeight: 600, color: '#B693F8',
          ...
          <Link href="/ips" style={{
            ...
            alignItems: 'center',
            gap: '6px',
            border: '1.5px solid rgba(182,147,248,0.35)',
            padding: '10px 20px',
            borderRadius: '100px',
            transition: 'all 0.3s',
          }}>查看全部 IP →</Link>
        ...
        <div style={{
          ...
          {preview.map(ip => (
            <div key={ip.id} style={{
              ...
              borderRadius: '28px',
              overflow: 'hidden',
              boxShadow: '0 8px 32px rgba(182,147,248,0.12)',
              ...
              onMouseEnter={e => {
                ...
                el.style.boxShadow = '0 20px 48px rgba(182,147,248,0.25)'
              }}
              onMouseLeave={e => {
                const el = e.currentTarget as HTMLElement
                el.style.transform = ''
                el.style.boxShadow = '0 8px 32px rgba(182,147,248,0.12)'
              }}
            >
              {/* Color band */}
              <div style={{
                height: '120px',
                background: `linear-gradient(135deg, ${ip.colorFrom}, ${ip.colorTo})`,
                display: 'flex',
                alignItems: 'center',
              ...
              <div style={{ padding: '1.5rem' }}>
                <div style={{
                  fontSize: '0.7rem', fontWeight: 600, color: ip.accentColor,
                  background: `${ip.accentColor}18`,
